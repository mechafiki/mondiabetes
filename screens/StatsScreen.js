...
import {GlycemicTests} from './GlycemicTests';
...
export function StatsHomeScreen({ navigation }) {
      ...
      <ScrollView contentContainerStyle={styles.container} >
        ...
        <View style={{position:'absolute',top:0,right:0,zIndex:999}}><SvgComponent /></View>
          <Animatable.View 
              ...
              iterationCount={1}
              direction="alternate">
              <TouchableOpacity style={styles.cards} onPress={()=> navigation.navigate('GlycemicTests')}>

                   <Text style={styles.cardText}>Historiques des tests</Text>
                   <View style={{ zIndex: 999}}><Entypo name="back-in-time" size={36} color="#fff" /></View>
          ...
          <Animatable.View
              ...
              iterationCount={1}
              direction="alternate">
              <TouchableOpacity style={styles.cards} onPress={()=> navigation.navigate('Activites')}>
                   <Text style={styles.cardText}>Activités sportives</Text>
                   <View style={{ zIndex: 999}}><FontAwesome5 name="running" size={36} color="#fff" /></View>
                   <View style={styles.shape}><Text></Text></View>
              </TouchableOpacity>
          </Animatable.View>
...
export function StatsScreen({navigation}){
      ...
      return (
        <Stack.Navigator  screenOptions={{headerShown: false}} initialRouteName="StatsHomeScreen">
          <Stack.Screen name="StatsHomeScreen" component={StatsHomeScreen}  />
          <Stack.Screen name="GlycemicTests" component={GlycemicTests} />
          <Stack.Screen name="Activites" component={ActivitiesScreen} />
        </Stack.Navigator>
      );
    }
