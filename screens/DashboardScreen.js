...
export function DashboardScreen({ navigation }){
    ...
    const submitTest = async() => {
        if ( valTest < 0 || valTest > 2 ){
            ...
            alert('Le champ valeur ne peut pas être vide ');
        }
        else if ( !typeTest ){
            alert("Le champ type du test ne peut pas être vide ");
        }
        else {
            if ( valTest > 1.4 ){
                alert("Votre glycèmie est trop élevée !! Veuillez consulter votre médecin");
            }
            else if( valTest < 0.7){
        ...
        <SafeAreaView  style={{flex:1}} >
            ...
            <View style={styles.headerTitle}>
                ...
                <View style={styles.cards}>
                    ...
                    <View style={styles.add}>
                        <RNPickerSelect 
                            ...
                            value={typeTest}
                            onValueChange={(value) => setTypeTest(value)}
                                items={[
                                    { label: 'à jeun', value: 'à jeun' },
                                    { label: 'après repas', value: 'post prandial' },
                                ]}
                        />
                ...
                <View style={styles.cards}>
                    ...
                    <Text style={styles.addText}>Ajouter votre hydratation du jour ( en Litres )</Text>
                    <View style={styles.add}>
                        <TextInput style={styles.input}
                            placeholder="Entrez la valeur"
                            keyboardType='numeric'
